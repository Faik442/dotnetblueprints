...
/// </summary>
public sealed class UpdateCompanyRoleCommandValidator : AbstractValidator<UpdateCompanyRoleCommand>
{
    private readonly IAuthDbContext _context;

    public UpdateCompanyRoleCommandValidator(IAuthDbContext context)
    {
        _context = context;
