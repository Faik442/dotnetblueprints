...
public sealed class RemoveRoleFromUserInCompanyCommandValidator : AbstractValidator<RemoveRoleFromUserInCompanyCommand>
{
    public RemoveRoleFromUserInCompanyCommandValidator()
    {
